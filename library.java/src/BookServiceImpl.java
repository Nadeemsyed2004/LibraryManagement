...
public class BookServiceImpl implements BookServiceInterface {
    ...
    public void addUser() {
    	String userid= validator.validateUserId();
        String name=validator.validateUserName("Name");
        String ph_no=validator.validateUserPhone();
         User user=new User(userid,name,ph_no);
         users.add(user);
    ...
    public void showUser() {
        boolean flag=false;
        System.out.println("\n----------------------------------------------------------------------------------------------");
        System.out.format(CYAN+"%s%15s%15s","ID","Name    ","Phone_Number"+RESET);
       System.out.println("\n----------------------------------------------------------------------------------------------");

          for (User user:users){
              System.out.format("%s%15s%15s",user.getId(),user.getName(),user.getPhone());
              System.out.println();
              flag=true;
            }
        System.out.println("\n----------------------------------------------------------------------------------------------");
       if(flag==false)
           System.out.println(RED+"There are no Users registered!"+RESET);
    }
    
    public void addStaff() {
    	String staffid= validator.validateStaffId();
        String name=validator.validateStaffName("Name");
        String salary= validator.validateSalary();
        String ph_no=validator.validateStaffPhone();
         Staff staff=new Staff(staffid,name,salary,ph_no);
         staffs.add(staff);
         System.out.println(GREEN+"Staff Added Successfully !!!"+RESET);
    ...
    public void showStaff() {
        boolean flag=false;
        System.out.println("\n----------------------------------------------------------------------------------------------");
        System.out.format(CYAN+"%s%15s%15s%15s","ID","Name    ","Salary     ","Phone_Number"+RESET);
       System.out.println("\n----------------------------------------------------------------------------------------------");

          for (Staff staff:staffs){
              System.out.format("%s%15s%15s%15s",staff.getId(),staff.getName(),staff.getSalary(),staff.getPhone());
              System.out.println();
              flag=true;
            }
        System.out.println("\n----------------------------------------------------------------------------------------------");
       if(flag==false)
           System.out.println(RED+"There are no Staffs registered!"+RESET);
    }
}